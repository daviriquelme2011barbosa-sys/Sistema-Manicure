-- Adiciona consentimento LGPD à tabela clientes e atualiza a view.
-- Seguro para rodar em banco já configurado — clientes existentes recebem true por padrão.

-- 1. Nova coluna na tabela
alter table public.clientes
  add column if not exists autoriza_contato boolean not null default true;
...
group by c.id, c.nome, c.whatsapp, c.observacoes, c.autoriza_contato;
